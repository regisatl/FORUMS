...
<div class="container">
	...
	if(isset($questionDate)){
		...
		<p><?=$questionContenu;?></p>
		<small><em><?='<a href="profile.php?id='.$questionIdAuteur.'">'. $questionEmailAuteur .'</a> &nbsp'. $questionDate; ?></em></small>
		</section>
		<br>
		<section class="show-answers">
			<form class="form-group" method="POST">
			 <div class="mb-3">
			    ...
			    <textarea  type="text" class="form-control" name="reponse" placeholder="" required=""></textarea>
			    <br>
